  ...
  return (
    <main className="body">
      <section className="about_section card">
        <div className="left">
          <h1 className="title_primary">Sanjit Sarkar</h1>
          <p className="title_tertiary">
            I'm a Full Stack Developer with MERN, Android Developer with Flutter
            and Kotlin.
          </p>
        </div>
        ...
        <ul className="tech_list">
          ...
          <li>
            <Image
              ...
              className="tech_icon javascript"
            />
            Javascript
          </li>
          <li>
          ...
          <li>
            <Image
              width="40%"
              height="40%"
              src="/img/icons/flutter.svg"
              className="tech_icon flutter"
            />
            Flutter
          </li>
          <li>
            <Image
              width="40%"
              height="40%"
              src="/img/icons/android.svg"
              className="tech_icon android"
            />
            Android
          </li>
        </ul>
